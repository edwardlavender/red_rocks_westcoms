...
This repository contains methods, written in `R` and organised as an `R Project`, for the exploration of hydrodynamic conditions in the Red Rocks and Longay Marine Protected Area (MPA) and around survey stations where flapper skate (_Dipturus intermedius_) have been documented. These methods support Dodd et al. (in press). First report of an egg nursery for the Critically Endangered flapper skate _Dipturus intermedius_ (Rajiformes: Rajidae). Aquat. Conserv. 
